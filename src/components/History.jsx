...
function History() {
  ...
  return (
    <div className={`p-4 bg-cyan-200 flex flex-col w-[75%] md:w-[290px] space-y-3 relative ${!toggle ? "block":"hidden"} absolute top-0 left-0 z-[999]`} style={{ height: `calc(100vh - ${navWidth}px)`}} >
